<script>
import BaseLayer from '@/components/openlayers-gis/layers/BaseLayer.vue'
import { nanoid } from 'nanoid'
import { addClusterLayer, addVectorSource, setFeatures, setFeatureStyle, setStyle, validObjKey } from '@/components/openlayers-gis/utils'
...
import { arrowLine } from '@/components/openlayers-gis/utils/arrowLine'
